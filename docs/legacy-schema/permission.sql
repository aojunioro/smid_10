...
-- Insert groups
INSERT INTO system_group (id, name, frontpage_id) VALUES (1, 'Template - Admin', NULL);
INSERT INTO system_group (id, name, frontpage_id) VALUES (2, 'Template - Users', NULL);
INSERT INTO system_group (id, name, frontpage_id) VALUES (3, 'Application - Programs', NULL);
...
INSERT INTO system_program (id, name, controller) values ((SELECT coalesce(max(id),0)+1 FROM system_program b), 'Sync Programas Form', 'SyncProgramForm');
...
CREATE INDEX sys_group_frontpage_idx ON system_group(frontpage_id);
