...
### Backend (Fase 0.9 — Suporte) — concluído em 2026-05-15

1. ~~Ler SPEC_SUPORTE e planejar implementação~~ — concluído
2. ~~Verificar tabelas existentes no banco smid~~ — concluído
3. ~~Criar tabelas faltantes (suportes)~~ — concluído
4. ~~Atualizar entidades Suporte~~ — concluído
5. ~~Implementar repositório SuporteRepository~~ — concluído
6. ~~Implementar serviço SuporteService~~ — concluído
7. ~~Implementar handler SuporteHandler~~ — concluído
8. ~~Adicionar rotas de suporte no routes.go~~ — concluído
9. ~~Deploy e testar endpoints de suporte~~ — concluído (POST /api/v1/suporte/suportes, GET /api/v1/suporte/suportes, GET /api/v1/suporte/suportes/:id, PUT /api/v1/suporte/suportes/:id, DELETE /api/v1/suporte/suportes/:id)
